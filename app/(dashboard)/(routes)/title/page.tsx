...
const TitlePage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post('/api/title', { messages: newMessages });
  ...
  return ( 
    <div>
      <Heading
        ...
        description="Elevate your YouTube presence effortlessly with our AI Title Generator."
        icon={YoutubeIcon}
      ...
      <div className="px-4 lg:px-8">
        <div>
          <Form {...form}>
            ...
            >
                  ...
                  <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="m-0 pl-2 bg-zinc-800 text-zinc-100 rounded-2xl">
                      <Input
                        ...
                        disabled={isLoading} 
                        placeholder="Suggest me a title on topic History of Ram Mandir, Ayodhya." 
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
              ...
              />
              <Button className="rounded-2xl bg-red-900 hover:bg-zinc-900 col-span-12 lg:col-span-2 w-full" type="submit" disabled={isLoading} size="icon">
                Generate
              </Button>
            </form>
          </Form>
        ...
        <div className="space-y-4 mt-4">
          ...
          {messages.length === 0 && !isLoading && (
            <Empty label="No Titles Generated." />
          )}
          <div className="flex flex-col-reverse gap-y-4">
            {messages.map((message) => (
              ...
              className={cn(
                ...
                message.role === "assistant" ? "bg-zinc-800 text-zinc-200 shadow-2xl shadow-zinc-950" : "bg-red-900 text-zinc-200 shadow-2xl shadow-zinc-950",
              )}
              >
