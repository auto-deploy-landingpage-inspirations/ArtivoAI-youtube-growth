...
const IdeasPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post('/api/ideas', { messages: newMessages });
  ...
  return ( 
    <div>
      <Heading
        title="Content Ideas"
        description="Empower your content journey with our AI-driven Ideas generator."
        icon={Bot}
      ...
      <div className="px-4 lg:px-8">
        <div>
          <Form {...form}>
            ...
            >
                  ...
                  <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="m-0 pl-2 bg-zinc-800 text-zinc-100 rounded-2xl">
                      <Input
                        ...
                        disabled={isLoading} 
                        placeholder="Suggest Some Ideas in Fitness Niche." 
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
              ...
              />
              <Button className="rounded-2xl bg-purple-900 hover:bg-zinc-900 col-span-12 lg:col-span-2 w-full" type="submit" disabled={isLoading} size="icon">
                Send
              </Button>
            </form>
          </Form>
        ...
        <div className="space-y-4 mt-4">
          ...
          {messages.length === 0 && !isLoading && (
            <Empty label="No Ideas Generated." />
          )}
          <div className="flex flex-col-reverse gap-y-4">
            {messages.map((message) => (
              ...
              className={cn(
                ...
                message.role === "assistant" ? "bg-zinc-800 text-zinc-200 shadow-2xl shadow-zinc-950" : "bg-purple-900 text-zinc-200 shadow-2xl shadow-zinc-950",
              )}
              >
