        ...
        <div>
          <Form {...form}>
            ...
            >
              ...
              />
              <Button className="rounded-2xl bg-purple-900 hover:bg-zinc-950 col-span-12 lg:col-span-2 w-full" type="submit" disabled={isLoading} size="icon">
                Send
              </Button>
            </form>
          </Form>
          ...
          <div className="flex flex-col-reverse gap-y-4">
            {messages.map((message) => (
              ...
              className={cn(
                ...
                message.role === "assistant" ? "bg-zinc-900 text-zinc-200" : "bg-purple-900 text-zinc-200",
              )}
              >
