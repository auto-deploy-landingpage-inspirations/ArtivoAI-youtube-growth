...
const TagsPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const response = await axios.post('/api/tags', { messages: newMessages });
  ...
  return ( 
    <div>
      <Heading
        ...
        description="Empower your content journey with our AI-driven tags generator."
        icon={Hash}
          ...
          <div className="flex flex-col-reverse gap-y-4">
            {messages.map((message) => (
              ...
              className={cn(
                ...
                message.role === "assistant" ? "bg-zinc-800 text-zinc-200 " : "bg-orange-900 text-zinc-200 ",
              )}
              >
