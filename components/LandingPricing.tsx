...
const LandingPricing = () => {
  ...
  return (
    <div id="pricing" className="w-full py-20 pt-32">
      <div className="px-[4vw] text-center text-5xl font-bold text-zinc-100 underline decoration-red-500">
        Pricing
      </div>
      <Alert className="w-[30vw] max-md:w-[80vw] ml-[35vw] max-md:ml-[10vw] bg-zinc-800 border-0 text-zinc-200 mt-12">
      ...
      <div className="flex px-[4vw] justify-center sm:space-x-4 max-sm:space-y-4 max-sm:flex-col">
        <div className=" text-zinc-100 text-center mt-14 rounded-2xl bg-zinc-800 p-10 w-auto">
          ...
          <Link href={isSignedIn ? "/dashboard" : "/sign-up"}>
            <Button
              variant={"ghost"}
              className="my-5 w-full p-8 font-bold hover:bg-zinc-800 hover:border-zinc-600 rounded-2xl min-[1440px]:text-2xl lg:text-xl md:text-sm"
            >
              Start for free
            </Button>
          </Link>
        ...
        <div className=" text-zinc-100 text-center mt-14 rounded-2xl bg-zinc-800 border border-red-900 shadow-2xl shadow-red-950 p-10 w-auto">
