    ...
    <div id="footer" className="w-full bg-zinc-800">
      <div className="px-[4vw] w-full flex max-md:flex-col max-md:text-center gap-8 justify-between py-12">
        ...
        <h1 className="text-3xl text-zinc-200 font-extrabold">artivo<span className="text-red-500">AI.</span></h1>
          <h1 className="max-md:text-justify">Our goal is to equip every content creator with the knowledge and
          motivation essential for their growth. We are dedicated to delivering
          a dynamic blend of cutting-edge technology and human insight,
          elevating your efficiency and increasing your viewership. No matter
          the obstacle ahead, we are committed to illuminating the path to your
          success.
          </h1>
        </div>
      ...
      <div className="py-6  bg-zinc-900 flex max-md:flex-col max-md:text-center justify-between text-zinc-500 font-light px-[4vw]">
