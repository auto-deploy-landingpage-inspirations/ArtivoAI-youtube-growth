...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 rounded-2xl group/bento hover:shadow-xl transition duration-200 p-4 bg-zinc-950 border-zinc-900 border justify-between flex flex-col space-y-4",
        className
      )}
    >
      {header}
